...
contract Assignment1 is INFTMINTER, ERC721("AprilBreakToken", "ABT"), BaseAssignment(0x80A2FBEC8E3a12931F68f1C1afedEf43aBAE8541) {

    using Counters for Counters.Counter;
    using Base64 for bytes;
    using Strings for uint256; // for every object of type unit256 use methods for type Strings (!)
    ...
    function flipSaleStatus() public {
        ...
        require(msg.sender == getOwner() || isValidator(msg.sender), "Only owner or validator can change the sale status");

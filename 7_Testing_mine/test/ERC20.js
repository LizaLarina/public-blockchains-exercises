...
describe("ERC20", function () {
    ...
    async function deployERC20() {
        ...
        console.log("accounts!:", owner.address, otherAccount.address);
    ...
    describe("Events", function () {
        it("Should emit Transfer events", async function () {
            ...
            // Transfer 50 tokens from owner to owner //7_?? to otherAccount
            ...
            // Transfer COINS tokens from owner to otherAccount //from otherAcc to owner
